...
class SortingTest extends FunSpec with Matchers {
  describe("Sorter") {
    it("should sort the elements") {
      ...
      Sorting.bubbleSort(Array(-5, 5, 23, 0, -34, 67)) should be(Array(-34, -5, 0, 5, 23, 67))
      Sorting.bubbleSort(Array(5)) should be(Array(5))
      Sorting.bubbleSort(Array()) should be(Array())
    }
  }
